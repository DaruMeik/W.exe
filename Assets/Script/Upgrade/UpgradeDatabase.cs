...
public class UpgradeDatabase : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        upgradeList.Add(new Upgrade(upgradeList.Count, 1, "Long Shock", "Increase stun duration of shockwave slightly when possess.", new Upgrade_ShockWaveStun1()));
        upgradeList.Add(new Upgrade(upgradeList.Count, 2, "Longer Shock", "Increase stun duration of shockwave moderately when possess.", new Upgrade_ShockWaveStun2()));
        upgradeList.Add(new Upgrade(upgradeList.Count, 3, "Longest Shock", "Increase stun duration of shockwave greatly when possess.", new Upgrade_ShockWaveStun3()));
