...
public class WeaponDatabase : MonoBehaviour
{
    ...
    // Special enemy
    public static List<Weapon> kataWeaponList = new List<Weapon>();
    public GameObject[] kataWeaponHitBox;
    ...
    private void OnEnable()
    {
        ...
        weaponList.Add(new Weapon(0, "Buster", "00_Buster", "Gun", -1, 7, 20, 75, 0, "Your trustworthy pistol", 0, weaponHitBox[0], weaponSprite[0], new Wea00_BusterEffect()));
        ...
        weaponList.Add(new Weapon(2, "ShortSword", "02_ShortSword", "Melee", 8, 20, 12, 100, 0, "Simple short sword", 1, weaponHitBox[2], weaponSprite[2], new Wea02_ShortSwordEffect()));
        ...
        weaponList.Add(new Weapon(7, "Timer", null, "Special", 5, 20, 15, 100, 0, "Set up a slowly-exploded seed.", 1, weaponHitBox[7], weaponSprite[7], new Wea07_TimerSeedEffect()));
        ...
        weaponList.Add(new Weapon(9, "PaintGun", null, "Gun", -1, 1, 30, 80, 40, "Shoot mud that slow targets", 0, weaponHitBox[9], weaponSprite[9], new Wea09_PaintGunEffect()));
        ...
        weaponList.Add(new Weapon(11, "ChargeSpear", "11_ChargeSpear", "Melee", 4, 30, 5, 100, 0, "Charge ahead", 1, weaponHitBox[11], weaponSprite[11], new Wea11_ChargeSpearEffect()));
        weaponList.Add(new Weapon(12, "Katana", "12_Katana", "Charge Melee", 5, 50, 40, 100, 15, "Slow time then slide.", 1, weaponHitBox[12], weaponSprite[12], new Wea12_KatanaEffect()));

        kataWeaponList.Add(new Weapon(0, "WideSlash", null, "Melee", -1, 60, 12, 100, 0, "Katana's special wide slash", -1, kataWeaponHitBox[0], null, new Kata00_WideSlashEffect()));
        kataWeaponList.Add(new Weapon(1, "ShockWave", null, "Gun", -1, 40, 5, 100, 0, "Katana's special shock wave", -1, kataWeaponHitBox[1], null, new Kata01_ShockWaveEffect()));
        kataWeaponList.Add(new Weapon(2, "ThreeWave", null, "Gun", -1, 40, 5, 100, 0, "Katana's special 3 shock waves", -1, kataWeaponHitBox[1], null, new Kata02_ThriceWaveEffect()));
    }
}
