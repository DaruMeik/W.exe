...
public class WeaponDatabase : MonoBehaviour
{
    ...
    {
        weaponList.Add(new Weapon(0, "Buster", "00_Buster", "Semiauto", -1, 6, 20, 85, 0, "Your trustworthy pistol", 0, weaponHitBox[0], weaponSprite[0], new Wea00_BusterEffect()));
        weaponList.Add(new Weapon(1, "GatlingGun", null, "Fullauto", 20, 6, 50, 75, 30, "Simple Fullauto gun", 1, weaponHitBox[1], weaponSprite[1], new Wea01_GatlingEffect()));
        ...
        weaponList.Add(new Weapon(3, "Shotgun", "03_Shotgun", "Semiauto", 6, 10, 5, 100, 0, "Simple shotgun", 1, weaponHitBox[3], weaponSprite[3], new Wea03_ShotgunEffect()));
        ...
        weaponList.Add(new Weapon(8, "ProtectorLantern", "08_ProtectorLantern", "Special", 1, 50, 5, 100, 0, "Give you a shield in one direction (only one at a time)", 1, weaponHitBox[8], weaponSprite[8], new Wea08_ProtectorLanternEffect()));
